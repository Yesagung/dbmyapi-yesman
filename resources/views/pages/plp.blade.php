                ...
                <div class="col-lg-3 col-md-3 order-md-1 order-2  small-mt__40">
                    <div class="shop-widget widget-shop-publishers mt-3">
                        <div class="product-filter">
                            <h6 class="mb-20">Publisher</h6>
                            <select class="_filter form-select form-select-sm" name="_publisher" 
                            onchange="getData()">
                                <option value="" selected>All</option>
                                <option value="kahfa">Kahfa</option>
                                <option value="harriman house">Kain Kyi</option>
                                <option value="kain kyi">Balai Pustaka</option>
                                <option value="kain na">Kain Na</option>
                                <option value="kain">Kain</option>
                                <option value="kain trouser">Kain Trouser</option>
                                <option value="kain kampala angel">Kain Kampala Angel</option>
                                <option value="kain producers">Kain Producers</option>
                            </select>
                        </div>
                    </div>
                    <!-- Product Filter -->
                    ...
                    <div class="shop-widget">
                        <div class="product-filter">
                            ...
                            <div class="blog-tagcloud">
                                <a href="#" class="selected">Best Seller</a>
                                <a href="#">Rekomendation</a>
                                <a href="#">Premium</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="shop-toolbar__items shop-toolbar__item--left">
                                ...
                                <div class="shop-toolbar__item">
                                    ...
                                    name="_sort_by" onchange="getData()">
                                        ...
                                        <option value="latest_publication">Sort by time latest</option>
