                    ...
                    <div class="col-lg-12 d-none d-md-block">
                        <div class="top-logo-area">
                            <div class="logo text-md-center">
                                <a href="{{route('home')}}"><img src="{{asset('assets/images/logo/kain.jpeg')}}" alt="logo" style="width:40%"></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 col-lg-3 col-6">
                        ...
                        <div class="logo__hidden text-start">
                            <a href="{{route('home')}}"><img src="{{asset('assets/images/logo/kain.jpeg')}}" alt="" style="height:40px"></a>
                        </div>
                    </div>
            ...
            <div class="modal-box-wrapper">
                <div class="helendo-tabs">
                    <ul class="nav" role="tablist">
                        <li class="tab__item nav-item active">
                            <a href="#tab_list_06" class="nav-link active" data-bs-toggle="tab" role="tab">Login</a>
                        </li>
                        <li class="tab__item nav-item">
                            <a href="#tab_list_07" class="nav-link" data-bs-toggle="tab" role="tab">Our Register</a>
                        </li>
                    </ul>
                </div>
                <div class="tab-content content-modal-box">
                    <div class="tab-pane fade show active" id="tab_list_06" role="tabpanel">
                        <form class="account-form-box" id="form-login">
                            ...
                            <div class="checkbox-wrap mt-10">
                                <label class="label-for-checkbox inline mt-15">
                                    <input type="checkbox" class="input-checkbox" id="rememberme" name="rememberme" value="forever">
                        ...
                        <div id="form-login-loading" style="text-aligm:center;display:none">
                    ...
                    <div class="tab-pane fade" id="tab_list_07" role="tabpanel">
                        <form class="account-form-box" id="form-register">
                            ...
                            <div class="button-box mt-25">
                                <a href="#" class="btn btn--full btn--black" 
                                id="form-register-btn">Log in</a>
                            </div>
                        </form>
