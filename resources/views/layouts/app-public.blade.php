...
<head>
    ...
    <title>@yield('title') | 422023030-Yesman Natanael</title>
    ...
    <body class="box-home">
        ...
        {{-- Plugins JS (Please remove the comment from below plugins.min.js for better
        website load performance and remove plugins js files from avobe--}}
        {{-- <script src="{{asset('assets/js/plugins/wow.min.js')}}"></script> --}}
